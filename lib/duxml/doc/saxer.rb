...
module Saxer
  ...
  attr_accessor :io
  # @param path [String] path of file to sax parse
  # @return [Duxml::Doc] finished document with each Element's line and column info added
  def sax(doc)
    saxer = DocuLiner.new(doc, history)
