...
class DuxmlObjectTest < MiniTest::Test
  def setup
  end

  def test_init_nil
   assert_equal 'object', Duxml::Object.new(nil).type
  end

  def test_init_text_child
    e = Duxml::Object.new %(<coop>text</coop>)
    assert %(<coop>text</coop>), e.xml.to_s
  end

  def test_mixed_content
    e = Duxml::Object.new %(<coop>text<interloper/>more text</coop>)
  ...
  def test_init_str
    ...
    e = Duxml::Object.new(test_xml.to_s)
    assert_equal test_xml.to_s, e.xml.to_s
  end

  def test_init_simple
    test_xml = Nokogiri::XML(%(<coop id="cooper0"/>)).root
    e = Duxml::Object.new(test_xml)
    assert_equal test_xml.to_s, e.xml.to_s
  end
  ...
  def test_init_hierarchy
    e = Duxml::Object.new(%(<coop id="cooper0"><danglers id="danglers0">dangling</danglers><chunks id="chunk0">chunky</chunks></coop>))
