require File.expand_path(File.dirname(__FILE__) + '/../../../lib/duxml/doc/grammar/rule/text_rule')
require File.expand_path(File.dirname(__FILE__) + '/../../../lib/duxml/doc/history/new_text')
require File.expand_path(File.dirname(__FILE__) + '/../../../lib/duxml/doc/history/change_text')
require File.expand_path(File.dirname(__FILE__) + '/../../../lib/duxml/doc/grammar/pattern/text_pattern')
