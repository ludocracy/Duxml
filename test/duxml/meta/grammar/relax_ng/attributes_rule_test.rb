require File.expand_path(File.dirname(__FILE__) + '/../../../../../lib/duxml/meta/grammar/relax_ng/attributes_rule')
require 'test/unit'
...
class RelaxNGTest < Test::Unit::TestCase
  ...
  def test_required_attribute_relaxng
    ...
    # first reference
    rng = g.relaxng
    assert_equal 'required', rng.css("doc[@name='node']/ref").last['name']
  ...
  def test_implied_attribute_relaxng
    ...
    rng = g.relaxng
    nodes = rng.css("doc[@name='node']/optional/ref")
